...
*/
SELECT total_installation."Postcode", total_installation."Installations Solar 2017", total_installation."Installations Solar 2018", total_installation."Installations Solar 2019" 
from total_installation
where total_installation."Postcode" > 2999
and total_installation."Postcode" <3999;

SELECT postcodes_geo."postcode", postcodes_geo."suburb", total_installation."Installations Solar 2017"
from postcodes_geo
LEFT OUTER JOIN total_installation 
on postcodes_geo."postcode" = total_installation."Postcode"



select * from postcodes_geo;
select * from total_installation;
